...
def search_semantic_scholar(
    ...
    *,
    ...
    url = f"{SEMANTIC_SCHOLAR_SEARCH_URL}?{encoded}"
...
def fetch_semantic_scholar_soft(
    ...
    *,
    ...
    """
    Like search_semantic_scholar but returns ([], error_message, cache_hit) instead of raising.
    """
    try:
        papers, cache_hit = search_semantic_scholar(
            query,
            limit=limit,
            offset=offset,
            year=year,
